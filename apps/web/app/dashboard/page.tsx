        ...
        {project && summary ? (
          ...
          <div className="glass-card rounded-2xl p-12 text-center border border-slate-200 dark:border-slate-800/60 shadow-sm">
            ...
            <p className="text-xs text-slate-600 dark:text-slate-400 max-w-md mx-auto mb-4">
              Click <strong className="text-amber-600 dark:text-amber-300 font-semibold">"Load Benchmark Demo Thread"</strong> above to test the entire pipeline with an 18-message client thread, or paste your own project details.
            </p>
          </div>
        )}
